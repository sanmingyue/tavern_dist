...
| **未开之花汤泉脚本** | **`tq-v`**     | **`tq-v0.0.3`**     | **未开之花汤泉零层美化与玩法前端脚本**                                |
...
```javascript
import 'https://testingcf.jsdelivr.net/gh/sanmingyue/tavern_dist@tq-v0.0.3/dist/汤泉/脚本/零层美化/index.js';
```
...
| **未开之花汤泉脚本 CDN**    | `@tq-v0.0.3/dist/汤泉/脚本/零层美化/index.js`                   |
