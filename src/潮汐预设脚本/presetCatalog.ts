// CDN 基础路径（版本号会在推送时更新）
export const CDN_BASE = 'https://testingcf.jsdelivr.net/gh/sanmingyue/tavern_dist@latest/dist/presets';
...
export const PRESET_CATALOG: PresetCatalogItem[] = [
  {
    name: '浮生 Soul',
    filename: '浮生Soul.json',
    description: '基于潮汐预设改造的 DeepSeek V4 专用版。雌小鬼浮生人格，简洁COT思维链，DSV4深度适配。',
    tags: ['新增', 'DeepseekV4预设'],
    author: '三明月',
  },
  {
    name: '潮汐 Plum blossom',
    filename: '潮汐Plum blossom.json',
    description: '最新版预设。杀八股能力极强，可以做到零八股。正文质量最高，Gemini 百分百适配。',
    tags: ['最新', '零八股', 'Gemini', 'Claude'],
    author: '三明月',
  },
  {
    name: '潮汐 Chaoxi',
  ...
  {
    name: '【明月秋青】6.0.1',
    filename: '【明月秋青】6.0.1.json',
    description: '重型预设，TOKEN 消耗高。活人感与人设挖掘深度比潮汐更强，适合追求极致角色表现的用户。',
    tags: ['重型', '深度人设', '活人感', 'Claude'],
    author: '三明月',
  },
  {
    name: '明月秋青 NAI 提示词版',
